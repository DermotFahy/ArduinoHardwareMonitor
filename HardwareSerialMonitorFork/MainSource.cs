    ...
    public partial class Form1 : Form
    {
        ...
        private void dataCheck()//function overload with 0 arguments, called when a with the default serial port on a timer
        {
          ...
          */
            ...
            // Dermots Changes
            string DermotCPUl = "CPU Load: ", DermotCPUt = "CPU Temp: ";
            string DermotGPUl = "GPU Load: ", DermotGPUt = "GPU Temp: ";
            cpuLoad = cpuLoad + "%                            ";
            cpuTemp = cpuTemp + "c                            ";
            gpuLoad = gpuLoad + "%                            ";
            gpuTemp = gpuTemp + "c";
            ...
            {
                sendToArduino(DermotCPUl + cpuLoad + DermotCPUt + cpuTemp + DermotGPUl + gpuLoad + DermotGPUt + gpuTemp);//send the string to the function
